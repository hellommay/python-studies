...
### 1. Automação de Cadastro de Produtos Básico
Script desenvolvido para otimizar o processo de leitura de dados e preenchimento de cadastros em plataformas web.
